...
export function ShareModal({ isOpen, onClose, url }: ShareModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Share Conversation" size="sm">
      <div className="space-y-5">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 p-3 bg-[rgba(var(--color-card),0.8)] rounded-xl border border-[rgba(var(--color-border),0.5)]">
            <Link className="w-4 h-4 text-theme-muted flex-shrink-0" />
            <code className="flex-1 text-sm text-theme-foreground font-mono truncate">
              {url}
            </code>
            <button
              onClick={handleCopy}
          ...
          <div className="flex items-center justify-center gap-3">
            {shareLinks.map((social) => (
              <button
                ...
                className={`
                  p-3 rounded-xl border border-[rgba(var(--color-border),0.5)]
                  bg-[rgba(var(--color-card),1)]
                  text-theme-muted
